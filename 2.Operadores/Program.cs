namespace _2.Operadores
{
    internal class program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write($"suma: {num5}, resta: {num7}, division: {num8}, num9 {num9}, num10 {num10}");
            ...
            Console.Write($"num11: {num11}, num12: {num12}, num13: {num13}, num14: {num14}, num15: {num15}, num16: {num16}");
